  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-4 sm:px-6">
        {/* Mobile Layout: Logo centered on top, search/cart on second line */}
        <div className="flex lg:hidden flex-col items-center gap-3 py-4">
          <Link href="/" className="font-serif text-3xl sm:text-4xl tracking-tight">
            Techzo
          </Link>
        ...
        {/* Desktop Layout: Original wide layout */}
